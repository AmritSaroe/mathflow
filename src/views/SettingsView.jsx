...
function ThemeIcon({ dark }) {
  return dark
    ? <svg width="22" height="22" viewBox="0 0 22 22" fill="none" aria-hidden="true"><path d="M18.5 13.5A7.5 7.5 0 0 1 8.5 3.2 7.5 7.5 0 1 0 18.5 13.5Z" stroke="currentColor" strokeWidth="1.7" strokeLinejoin="round" /></svg>
    : <svg width="22" height="22" viewBox="0 0 22 22" fill="none" aria-hidden="true"><circle cx="11" cy="11" r="3.7" stroke="currentColor" strokeWidth="1.7" /><path d="M11 2.5v2M11 17.5v2M2.5 11h2M17.5 11h2M5 5l1.5 1.5M15.5 15.5L17 17M17 5l-1.5 1.5M6.5 15.5L5 17" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" /></svg>
}
  ...
  return (
    <div style={{ minHeight: '100%', background: 'var(--md-sys-color-background)' }}>
      ...
      <main style={{ maxWidth: 640, margin: '0 auto', padding: '20px 16px 32px' }}>
        ...
        <button type="button" className="md-state" onClick={onToggleTheme} style={{ width: '100%', display: 'flex', alignItems: 'center', gap: 14, padding: 16, border: 'none', borderRadius: 16, background: 'var(--md-sys-color-surface-container)', color: 'var(--md-sys-color-on-surface)', textAlign: 'left', cursor: 'pointer' }}>
          ...
          <span style={{ flex: 1 }}><span className="md-title-medium" style={{ display: 'block' }}>Theme</span><span className="md-body-medium" style={{ display: 'block', marginTop: 3, color: 'var(--md-sys-color-on-surface-variant)' }}>{dark ? 'Dark mode' : 'Light mode'}</span></span>
