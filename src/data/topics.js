...
export const TOPICS = {
  ...
  add_xy0_2d:   { name: 'Round number + 2D',       section: 'addition',       desc: 'e.g. 320 + 47',                  srs: false, generate: generateAddXY02D },
  ...
  sub_3d2d:     { name: 'Three minus two digit',    section: 'subtraction',   desc: 'e.g. 473 − 58',                  srs: false, generate: generateSub3D2D },
  ...
  mul_2d1d:     { name: 'Two-digit × single',       section: 'multiplication', desc: 'both ways e.g. 47×6 and 6×47',   srs: false, generate: generateMul2D1D },
  mul_2d2d:     { name: 'Two-digit multiplication', section: 'multiplication', desc: 'e.g. 47 × 63',                   srs: false, generate: generateMul2D2D },
  mul_1d3d:     { name: '1D × 3D both ways',        section: 'multiplication', desc: 'e.g. 4×473 and 473×4',           srs: false, generate: generateMul1D3D },
